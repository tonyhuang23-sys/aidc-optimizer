...
**AI辅助披露**：模型实现、数据分析与初稿写作由AI辅助完成，全部数值结果可由随附代码复现；v3.0依外部评估意见二修订，P0项（公式、算术、日期、排序）已逐项核对；v3.1依评估意见三修订，聚焦口径与归属（情景包因子界定、CE-NPV与WACC职责分工、融资价值归属贴现率口径、L5a结论边界）。
